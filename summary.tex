...
\section{Summary of ``Recent Improvements to the McErlang Model Checker''\cite{xxxxxxx}} 
...
\section{Summary of ``Formal Analysis of a Space Craft Controller using SPIN''\cite{xxxxxxx}} 
